...
export default function AboutPage() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#faf9f7] py-20 lg:py-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-[#a67c5b] font-bold tracking-[0.3em] uppercase text-xs mb-4 block">
            The Journey
          </span>
        ...
        <div className="space-y-20 lg:space-y-40">
          {storySections.map((section, index) => (
            <motion.div
              ...
              className={`flex flex-col items-center gap-10 lg:gap-24 ${
